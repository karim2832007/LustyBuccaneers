...
define config.name = "LustyBuccaneers"
...
define config.version = "0.39"
define version_end = 40
...
define version_id = int(config.version.split(".")[1])
define version_id_next = version_id + 1
...
define build.name = "LustyBuccaneers"
...
#define config.has_ambient = True
...
define config.save_directory = "LustyBuccaneers-1710165633"
...
init python:
    ...
    build.classify('game/images/**', 'data')
    build.classify('game/scripts/**', 'data')

    build.classify('game/movie/**', 'data')
...
#define config.layers = ['master', 'transient', 'location', 'uiphone', 'screens', 'overlay']
#define config.context_clear_layers = ['location', 'screens']
