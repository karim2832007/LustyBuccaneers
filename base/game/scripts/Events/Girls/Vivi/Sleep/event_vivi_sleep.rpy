...
label event_vivi_sleep:
    show screen screen_basic_black with Dissolve(0.6)

    $ ui_interface = False
    show events vivi sleep vivi_sleep
    ...
    menu menu_vivi_sleep:
        ...
        "Look closer at her tits":
            ...
            show cut_s_vivi_tits with Dissolve(0.3):
                pos (900, 200)
            pause 1.0
            ...
            hide cut_s_vivi_tits with Dissolve(0.5)

        "Look closer at her pussy":

            player "(Let's see what we have down here...)"

            show cut_s_vivi_pussy with Dissolve(0.3):
                pos (900, 200)
            pause 1.0
            ...
            hide cut_s_vivi_pussy with Dissolve(0.5)

        "Look closer at her feet":
            player "(Let's see what we have here...)"

            show cut_s_vivi_feet with Dissolve(0.3):
                pos (900, 200)
            pause 1.0
            ...
            hide cut_s_vivi_feet with Dissolve(0.5)
        ...
        "Jerk off":
            ...
            menu:
                "cum on tits":
                    ...
                    show cut_s_vivi_tits_cum with flash:
                        pos (900, 200)

                "cum on pussy":
                    window hide
                    play sound ["<silence 0.1>","cum_02","<silence 0.2>","cum_01"]
                    show cut_s_vivi_pussy_cum with flash:
                        pos (900, 200)

                "cum on feet":
                    window hide
                    play sound ["<silence 0.1>","cum_02","<silence 0.2>","cum_01"]
                    show cut_s_vivi_feet_cum with flash:
                        pos (900, 200)
